            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-10">
                ...
                <div className="border-t border-gray-300 mt-10 pt-6 flex flex-col sm:flex-row justify-between items-center text-center sm:text-left gap-4">
                    ...
                    <div className="flex space-x-4">
                        <a href="https://www.facebook.com/share/1BWvzvYur6/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" aria-label="Facebook"><Facebook className="text-gray-500 hover:text-gray-900 transition-colors" /></a>
                        <a href="https://www.tiktok.com/@gudinaandtsehaylegacy?_r=1&_t=ZS-98WGzDFkW1s" target="_blank" rel="noopener noreferrer" aria-label="TikTok">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="24" height="24" className="text-gray-500 hover:text-gray-900 transition-colors">
