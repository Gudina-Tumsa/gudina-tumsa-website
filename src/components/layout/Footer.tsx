...
function StoreButtons() {
    return (
        <div className="flex flex-row gap-4 mt-[5%] mb-[20%]">
            {/* App Store Button */}
            <button
                type="button"
                className="px-3 flex items-center justify-center w-50 h-14 text-white bg-black rounded-xl"
            >
    ...
    return (
        ...
        <footer className="bg-gray-200 border-t border-gray-200">
            <div className="w-[90%] mx-auto px-4 sm:px-6 lg:px-8 py-10">
                ...
                <div className="flex flex-row justify-between items-center">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            <li><a href="https://gudinaandtsehaylegacy.org/"
                                   className="hover:text-gray-900 transition-colors">Gudina and Tsehay Legacy</a></li>
                            <li><a href="https://gudinatumsafoundation.org/"
                                   className="hover:text-gray-900 transition-colors">Gudina Tumsa Foundation</a></li>
                            <li><a href="#" className="hover:text-gray-900 transition-colors">Ilaamee Ministry</a></li>
                            <li><a href="https://biftubole.org/" className="hover:text-gray-900 transition-colors">Biftu
                                Bole Mekane Yesus</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            ...
                            <li><a href="/collaborations"
                                   className="hover:text-gray-900 transition-colors">Collaboration</a></li>
                            <li><a href="/contactus" className="hover:text-gray-900 transition-colors">Contact &
                                Help</a></li>
                        </ul>
                    </div>
                ...
                {/* Bottom Section */}
                <div
                    className="border-t border-gray-200 pt-6 flex flex-col sm:flex-row justify-between items-center text-center sm:text-left gap-4">
                    {/* Copyright */}
                    ...
                    <div className="flex space-x-3">
                        ...
                        <Facebook className="text-[#9407F2] hover:text-gray-900 transition-colors"></Facebook>
                        <Twitter className="text-[#9407F2] hover:text-gray-900 transition-colors"></Twitter>
                        <Instagram className="text-[#9407F2] hover:text-gray-900 transition-colors"></Instagram>
                        <Linkedin className="text-[#9407F2] hover:text-gray-900 transition-colors"></Linkedin>
                    </div>
                </div>
