        ...
        <div className="mt-[-8%]">
            <div className="container mx-auto px-4 py-16">
                ...
                <div className="text-center max-w-4xl mx-auto mb-16">
                    <h1 className="font-black tracking-tighter text-slate-800 mb-6 leading-tight text-3xl sm:text-4xl md:text-5xl lg:text-6xl">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 items-stretch">
                        ...
                        <div className="flex flex-col h-full gap-6">
                            ...
                            <div className="bg-[#C084FC]/40 rounded-xl p-6 shadow flex flex-col justify-between flex-grow">
                                <h3 className="text-2xl md:text-4xl font-extrabold tracking-tight text-gray-800">
                            ...
                            <div className="flex-1 bg-[#C084FC]/25 rounded-xl p-8 flex flex-col items-center justify-center text-center shadow">
                                <h3 className="text-2xl font-bold tracking-tight text-slate-700">Explore the Archives</h3>
                        ...
                        <div className="flex flex-col h-full bg-[#C084FC] rounded-xl p-8 text-center items-center justify-center min-h-[600px] shadow-lg">
                            <h2 className="text-4xl md:text-5xl font-extrabold tracking-tight text-white leading-tight">A Legacy of Faith and Courage</h2>
                        ...
                        <div className="grid grid-rows-4 h-full gap-6">
                            ...
                            <div className="bg-[#C084FC]/15 rounded-xl p-8 flex flex-col items-center justify-center text-center shadow row-span-3">
                                <h3 className="text-2xl font-bold tracking-tight text-slate-700">Listen on the Go</h3>
                            ...
                            <div className="bg-[#C084FC]/40 rounded-xl p-6 flex items-center justify-center shadow row-span-1">
                                <h3 className="text-xl md:text-2xl font-bold tracking-tight text-gray-800 text-center">
